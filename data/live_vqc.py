...
class Live_VQCDataset(torch.utils.data.Dataset):
    def __init__(self, root='/data/ly/LIVE Video Quality Challenge (VQC) Database-selected', phase='train', norm=True,argument: List[Dict] = [],clip=1,):
        super().__init__()
        self.phase = phase
        self.norm = norm
