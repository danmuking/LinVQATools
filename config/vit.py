custom_imports = dict(
    imports=['cls_model', 'default_dataset', 'srocc', 'rmse',
             'plcc', 'krcc','accuracy', 'train_evaluator_hook', 'custom_ema_hook'],
    allow_failed_imports=False)
work_dir = 'work_dir/cls/10241053 vit_patch16_fragment32 cls'
visualizer = dict(
    type='Visualizer',
    vis_backends=[
        dict(
            type='WandbVisBackend',
            init_kwargs=dict(project='cls', name='10241053 vit patch16 fragment32 cls')
        ),
    ],
)
model = dict(
