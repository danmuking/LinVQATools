...
work_dir = 'work_dir/video_mae_vqa/11210933 video mae vqa'
visualizer = dict(
    type='Visualizer',
    vis_backends=[
        dict(
            type='WandbVisBackend',
            init_kwargs=dict(project='video mae vqa', name='11210933 video mae vqa')
        ),
    ],
)
model = dict(
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=0.000001, weight_decay=0.05),
