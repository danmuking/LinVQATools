...
work_dir = 'work_dir/video_mae_vqa/11111447 video mae vqa'
visualizer = dict(
    type='Visualizer',
    vis_backends=[
        dict(
            type='WandbVisBackend',
            init_kwargs=dict(project='video mae vqa', name='11111447 video mae vqa')
        ),
    ],
)
model = dict(
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            'model.vqa_head': dict(lr_mult=0.01),
