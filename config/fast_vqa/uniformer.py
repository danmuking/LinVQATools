...
work_dir = 'work_dir/faster_vqa/10281301 uniformer 4frame'
visualizer = dict(
    type='Visualizer',
    vis_backends=[
        dict(
            type='WandbVisBackend',
            init_kwargs=dict(project='faster vqa消融', name='10281301 uniformer 4frame')
        ),
    ],
)
model = dict(
    ...
    vqa_head=dict(name='VQAHead',in_channels=512,drop_rate=0.5,fc_in=8*7*7),
)
epochs = 800
batch_size = 6
num_workers = 6
