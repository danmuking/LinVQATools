...
work_dir = 'work_dir/faster_vqa/11041029 vit_patch16_fragment32 4frame gru'
visualizer = dict(
    type='Visualizer',
    vis_backends=[
        dict(
            type='WandbVisBackend',
            init_kwargs=dict(project='faster vqa消融', name='11041029 vit patch16 fragment32 4frame gru')
        ),
    ],
)
model = dict(
