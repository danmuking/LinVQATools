...
work_dir = 'work_dir/faster_vqa/10171112 vit_patch16_fragment32 4frame atte'
visualizer = dict(
    type='Visualizer',
    vis_backends=[
        dict(
            type='WandbVisBackend',
            init_kwargs=dict(project='faster vqa消融', name='10171112 vit patch16 fragment32 4frame atte')
        ),
    ],
)
model = dict(
