...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        x0 = x[:, :, 0::2, 0::2, :]  # B D/2 H/2 W/2 C
        x1 = x[:, :, 1::2, 0::2, :]  # B D/2 H/2 W/2 C
        x2 = x[:, :, 0::2, 1::2, :]  # B D/2 H/2 W/2 C
        x3 = x[:, :, 1::2, 1::2, :]  # B D/2 H/2 W/2 C
        x = torch.cat([x0, x1, x2, x3], -1)  # B D/2 H/2 W/2 8*C
        # print(x.shape)
