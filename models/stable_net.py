...
from .backbones.resnet import generate_model
from .backbones.swinv1_backbone import SwinTransformer
from .utils.raft.raft import RAFT
from .utils.stripformer.networks import get_generator
...
class Stablev2Evaluator(nn.Module):
    def __init__(
        ...
        # state_dict = torch.load('pretrained_weights/Stripformer_realblur_J.pth')
        ...
        # self.quality = self.quality_regression(512 + 768 * 16 + 320 * self.blur, 128, 1)
        self.quality = self.quality_regression(768 * 16, 128, 1)
